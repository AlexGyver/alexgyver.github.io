"use strict";(self.webpackChunkota_gyver=self.webpackChunkota_gyver||[]).push([[380],{380:(e,t,o)=>{o.r(t),o.d(t,{openNoPortPickedDialog:()=>a});var i=o(314);const l=i.y`
  <svg
    version="1.1"
    id="Capa_1"
...
`;let n=class extends i.s{render(){const e=(()=>{var e,t;const o=window.navigator.userAgent,i=(null===(t=null===(e=window.navigator)||void 0===e?void 0:e.userAgentData)||void 0===t?void 0:t.platform)||window.navigator.platform;return-1!==["macOS","Macintosh","MacIntel","MacPPC","Mac68K"].indexOf(i)?"Mac OS":-1!==["iPhone","iPad","iPod"].indexOf(i)?"iOS":-1!==["Win32","Win64","Windows","WinCE"].indexOf(i)?"Windows":/Android/.test(o)?"Android":/Linux/.test(i)?"Linux":null})();return i.x`
    ...
    `}tryAgain(){var e;this.close(),null===(e=this.doTryAgain)||void 0===e||e.call(this)}close(){this.shadowRoot.querySelector("ew-dialog").close()}async _handleClose(){this.parentNode.removeChild(this)}};n.styles=[i.z,i.i`
      li + li,
      li > ul {
        margin-top: 8px;
      }
